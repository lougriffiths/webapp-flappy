...
app.post('/score', function (request, response) {
 ...
 // response.send(request.body.Nickname + " ("
 //  + request.body.question + "): " + request.body.score)

});

app.get("/score", function (request, response) {
    var reader = csv.createCsvFileReader("scores.csv");
    reader.setColumnNames(["Nickname", "Question", "score"]);
    var scores = [];
